...
func cmdStatus(ctx context.Context, e *env, o *options, args []string) error {
	var probe bool
	fs, err := o.parse("deephost status", statusUsage, args, func(fs *flag.FlagSet) {
...
func cmdPlatformRebuild(ctx context.Context, e *env, o *options, args []string) error {
	var dryRun bool
	fs, err := o.parse("deephost platform rebuild", platformUsage, args, func(fs *flag.FlagSet) {
...
func cmdVersion(e *env, o *options, args []string) error {
	fs, err := o.parse("deephost version", versionUsage, args, nil)
	if err != nil {
		return err
	}
