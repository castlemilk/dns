...
func (h *harness) withToken() *harness {
	h.environ["DEEPHOST_API_TOKEN"] = testToken
	return h
}
...
func (h *harness) configPath() string {
	return filepath.Join(h.environ["XDG_CONFIG_HOME"], "deephost", "config.json")
}
