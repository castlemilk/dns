...
func cmdBillingStatus(ctx context.Context, e *env, o *options, args []string) error {
	fs, err := o.parse("deephost billing status", billingUsage, args, nil)
	if err != nil {
		return err
	}
...
func cmdBillingSummary(ctx context.Context, e *env, o *options, args []string) error {
	fs, err := o.parse("deephost billing summary", billingUsage, args, nil)
	if err != nil {
		return err
	}
	if err := noExtraArgs(fs, 0, billingUsage); err != nil {
...
func cmdBillingSubscribe(ctx context.Context, e *env, o *options, args []string) error {
	...
	fs, err := o.parse("deephost billing subscribe", billingUsage, args, func(fs *flag.FlagSet) {
	...
	if err := newPrinter(e, o).emit(result, func(w io.Writer) error {
		return fields(w,
			...
			pair("then run", "deephost billing confirm "+result.GetSessionId()),
		)
	}); err != nil {
		return err
	}
...
func cmdBillingConfirm(ctx context.Context, e *env, o *options, args []string) error {
	fs, err := o.parse("deephost billing confirm", billingUsage, args, nil)
	if err != nil {
		return err
	}
...
func cmdBillingPortal(ctx context.Context, e *env, o *options, args []string) error {
	...
	var openBrowser bool
	fs, err := o.parse("deephost billing portal", billingUsage, args, func(fs *flag.FlagSet) {
...
func cmdBillingInvoices(ctx context.Context, e *env, o *options, args []string) error {
	var limit uint
	var cursor string
	fs, err := o.parse("deephost billing invoices", billingUsage, args, func(fs *flag.FlagSet) {
...
func cmdBillingRetryWebhooks(ctx context.Context, e *env, o *options, args []string) error {
	fs, err := o.parse("deephost billing retry-webhooks", billingUsage, args, nil)
	if err != nil {
		return err
	}
	if err := noExtraArgs(fs, 0, billingUsage); err != nil {
